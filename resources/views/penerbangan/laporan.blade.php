                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="fas fa-check text-success me-2"></i>Audit internal maskapai</li>
                            <li><i class="fas fa-check text-success me-2"></i>Evaluasi operasional</li>
                            <li><i class="fas fa-check text-success me-2"></i>Monitoring aktivitas bulanan</li>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fas fa-info text-primary me-2"></i>Hanya menampilkan data unduhan Anda</li>
