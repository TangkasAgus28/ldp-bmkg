                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($item->tanggal_unduh->diffInDays() <= 3)
                                            <br><small class="text-success">{{ $item->tanggal_unduh->diffForHumans() }}</small>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
                ...
                <div class="timeline">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="mb-1 text-muted small">{{ Str::limit($item->dokumen->deskripsi, 80) }}</p>
                            <small class="text-muted">
                                <i class="fas fa-clock me-1"></i>
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('penerbangan.riwayat') }}" class="btn btn-secondary">
