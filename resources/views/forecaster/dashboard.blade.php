            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-md-3 mb-3">
                        <a href="{{ route('forecaster.dokumen.create') }}" class="btn btn-outline-primary btn-lg w-100">
                            <i class="fas fa-plus-circle fa-2x mb-2"></i><br>
                            Upload Dokumen Baru
                        </a>
                    </div>
                    <div class="col-md-3 mb-3">
                        <a href="{{ route('forecaster.dokumen.index') }}" class="btn btn-outline-success btn-lg w-100">
