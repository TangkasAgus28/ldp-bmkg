                    ...
                    <form action="{{ route('forecaster.dokumen.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                ...
                                placeholder="Contoh: Laporan Cuaca Harian 17 September 2025" maxlength="150" required>
                            @error('judul')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="4"
                                placeholder="Jelaskan isi dokumen dan informasi penting untuk maskapai..." required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled mb-0 small">
                                            <li><i class="fas fa-check text-success me-2"></i>Gunakan nama file yang jelas
                                            </li>
                                            <li><i class="fas fa-check text-success me-2"></i>Pastikan file tidak corrupt
                                            </li>
                                            <li><i class="fas fa-check text-success me-2"></i>Periksa isi dokumen sebelum
                                                upload</li>
                                            <li><i class="fas fa-check text-success me-2"></i>Berikan deskripsi yang
                                                informatif</li>
                                        </ul>
                                    </div>
                                </div>
